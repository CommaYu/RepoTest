...
public class PropertyConfigurator {
    ...
    public void configure(String filename) {
        ...
        try {
            ...
            Log.e(TAG,
                    "Failed to open the microlog properties file. Hint: the file should be in the /assets directory "
                            + filename + " " + e);
        }
    }
    ...
    public void configure(int resId) {
        ...
        try {
            ...
            Log.e(TAG,
                    "Did not find the microlog properties resource. Hint: this should be in the /res/raw directory "
                            + e);
        } catch (IOException e) {
    ...
    private void addAppender(String string, Properties properties) {
        ...
        try {
            ...
            Log.e(TAG,
                    "Specified appender class does not implement the Appender interface: "
                            + e);
        }
    }
    ...
    private void setPropertiesForFileAppender(Appender appender,
        ...
        String fileName = (String) properties
                .getProperty(FILE_APPENDER_FILE_NAME_KEY, "microlog.txt");
        ((FileAppender) appender).setFileName(fileName);

        String append_string = (String) properties
                .getProperty(FILE_APPENDER_APPEND_KEY, "true");
    ...
    private void setFormatter(Properties properties) {
        ...
        String formatterString = (String) properties
                .getProperty(FORMATTER_PREFIX_KEY, "PatternFormatter");
        ...
        try {
            ...
            if (formatter instanceof PatternFormatter) {
                String pattern = (String) properties.getProperty(
                        PATTERN_LAYOUT_PREFIX_KEY, "%r %c{1} [%P] %m %T");
            ...
            Log.e(TAG,
                    "Specified formatter class does not implement the Formatter interface: "
                            + e);
        }
    }
