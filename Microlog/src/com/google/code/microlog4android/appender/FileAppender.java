...
public class FileAppender extends AbstractAppender {
    ...
    protected synchronized File getExternalStorageDirectory() {
        ...
        if (sdk >= 8 && mContext != null) {
            ...
            try {
                /*
                 * Use indirection to invoke getExternalFilesDir(), this allows
                 * us to support platforms less than 8.
                 */
                getExtFilesDir = Context.class.getMethod("getExternalFilesDir",
                        new Class[] { String.class });
                /*
                 * Invoke getExtFilesDir with null argument
                 */
                externalStorageDirectory = (File) getExtFilesDir
                        .invoke(mContext, new Object[] { null });
            } catch (Throwable t) {
                Log.e(TAG,
                        "Could not execute method getExternalFilesDir() on sdk >=8",
                        t);
            }
        }
